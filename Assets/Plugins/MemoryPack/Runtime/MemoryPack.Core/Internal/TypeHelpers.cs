...
namespace MemoryPack.Internal
{
    internal static class TypeHelpers
    {
        ...
        private static readonly MethodInfo unsafeSizeOf = typeof(Unsafe).GetMethod("SizeOf")!;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool IsReferenceOrNullable<T>() => Cache<T>.IsReferenceOrNullable;
            ...
            static Cache()
            {
                try
                {
                    ...
                    if (type.IsSZArray)
                    {
                        ...
                        var containsReference = (bool)isReferenceOrContainsReferences.MakeGenericMethod(elementType!).Invoke(null, null)!;
